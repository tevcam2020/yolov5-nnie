...
#define SAMPLE_SVP_NNIE_MAX_THREAD_NUM            1 /*Multi thread number*/
#define SAMPLE_SVP_NNIE_YOLOV3_REPORT_BLOB_NUM    2 /*yolov3 report blob num*/
#define SAMPLE_SVP_NNIE_YOLOV3_EACH_GRID_BIAS_NUM 6 /*yolov3 bias num of each grid*/
#define SAMPLE_SVP_NNIE_YOLOV3_EACH_BBOX_INFER_RESULT_NUM   6 /* class + 4 + 1   //yolov3 inference result num of each bbox*/
