...
#define ISP_MAX_PIPE_NUM                     (4)
#define ISP_STRIPING_OVERLAP_DEFAULT         (256)

#define ISP_WDR_CHN_MAX                      (2)
#define ISP_SUPPORT_DE_MODULE                (1)

#define ISP_RES_WIDTH_MAX  4608,3840,2048,2048
#define ISP_RES_HEIGHT_MAX 4608,3840,2048,2048
...
#define AWB_LIB_NUM                          (4)
#define AE_LIB_NUM                           (4)

#define HI_ISP_SHARPEN_RGAIN                 (32)
#define HI_ISP_SHARPEN_BGAIN                 (32)
#define HI_ISP_SHARPEN_RGAIN_MAX             (32)
#define HI_ISP_SHARPEN_BGAIN_MAX             (32)

#define HI_ISP_SHARPEN_RGAIN_BIT             (63)
#define HI_ISP_SHARPEN_BGAIN_BIT             (63)
