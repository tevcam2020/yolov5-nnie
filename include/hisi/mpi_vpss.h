...
HI_S32 HI_MPI_VPSS_SetGrpNRTParam(VPSS_GRP VpssGrp, const VPSS_GRP_NRT_PARAM_S *pstVpssNrTParam);
HI_S32 HI_MPI_VPSS_GetGrpNRTParam(VPSS_GRP VpssGrp, VPSS_GRP_NRT_PARAM_S *pstVpssNrTParam);
